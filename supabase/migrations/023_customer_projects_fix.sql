...
-- Check and create customer_projects table if it doesn't exist
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'customer_projects') THEN
...
-- Check and create project_schemas table if it doesn't exist
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'project_schemas') THEN
...
-- Check and create project_features table if it doesn't exist
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'project_features') THEN
...
-- Check and create api_usage table if it doesn't exist
DO $$ 
BEGIN
...
-- Check and create project_templates table if it doesn't exist
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'project_templates') THEN
...
-- Check and create project_deployments table if it doesn't exist
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'project_deployments') THEN
...
DROP POLICY IF EXISTS "Users can update own projects" ON customer_projects;
DROP POLICY IF EXISTS "Users can delete own projects" ON customer_projects;
...
-- Project schemas policies
DROP POLICY IF EXISTS "Users can view own project schemas" ON project_schemas;
DROP POLICY IF EXISTS "Users can manage own project schemas" ON project_schemas;
...
DROP POLICY IF EXISTS "Users can view own project features" ON project_features;
DROP POLICY IF EXISTS "Users can manage own project features" ON project_features;
...
DROP TRIGGER IF EXISTS update_project_features_updated_at ON project_features;
...
SELECT 'customer_projects' as table_name, COUNT(*) as exists FROM information_schema.tables WHERE table_name = 'customer_projects'
UNION ALL
SELECT 'project_schemas', COUNT(*) FROM information_schema.tables WHERE table_name = 'project_schemas'
UNION ALL
SELECT 'project_features', COUNT(*) FROM information_schema.tables WHERE table_name = 'project_features'
UNION ALL
SELECT 'api_usage', COUNT(*) FROM information_schema.tables WHERE table_name = 'api_usage'
UNION ALL
SELECT 'project_templates', COUNT(*) FROM information_schema.tables WHERE table_name = 'project_templates'
UNION ALL
SELECT 'project_deployments', COUNT(*) FROM information_schema.tables WHERE table_name = 'project_deployments';